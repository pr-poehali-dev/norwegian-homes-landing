...
const projects = [
  { name: 'Фьорд', area: 142, price: '8,9 млн ₽', tag: 'Одноэтажный' },
  { name: 'Берген', area: 186, price: '12,4 млн ₽', tag: 'С мансардой' },
  { name: 'Тромсё', area: 98, price: '6,2 млн ₽', tag: 'Компактный' },
  { name: 'Осло', area: 224, price: '15,8 млн ₽', tag: 'Двухэтажный' },
  { name: 'Лофотен', area: 165, price: '10,7 млн ₽', tag: 'Панорамный' },
  { name: 'Нордкап', area: 268, price: '18,9 млн ₽', tag: 'Премиум' },
];
